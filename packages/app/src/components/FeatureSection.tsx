...
const features = [
  {
    name: "Toggl",
    description:
      "Toggl entries can be automatically imported, including custom descriptions",
    icon: SiToggl,
  },
  {
    name: "Jira",
  ...
  },
  {
    ...
    description:
      "Record holidays and they will automatically appear on your timesheet",
    icon: HolidayIcon,
  },
  {
    name: "Google Sheets Output",
    description:
      "All information can be exported daily to your Google Sheets timesheet, including custom descriptions",
    icon: SiGooglesheets,
  },
  {
    name: "Overtime Calculations",
    description:
      "Overtime is automatically calculated - including bank holidays and weekends",
    icon: ClockIcon,
  },
] as const;
