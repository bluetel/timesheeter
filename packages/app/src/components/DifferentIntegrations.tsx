...
export const DifferentIntegrations = () => {
    return (
        <section>
            <div id="features">
                <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6 pt-32">
                    <div className="md:w-2/3 lg:w-1/2">
                        ...
                        <h2 className="my-8 text-2xl font-bold text-gray-700 dark:text-white md:text-4xl">
                            Integrate with your existing content
                        </h2>
                        <p className="text-gray-600 dark:text-gray-300">ModelHero seamlessly integrates with your existing content management systems, allowing you to effortlessly create and deploy personalized bots that enhance your brand's voice and style.
                            Models update live in response to changes in your content, so you can always be sure it's up to date.
                        </p>
                            ...
                            <div className="relative space-y-8 py-12 p-8">
                                ...
                                <a href="#" className="flex items-center justify-between group-hover:text-secondary">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 -translate-x-4 text-2xl opacity-0 transition duration-300 group-hover:translate-x-0 group-hover:opacity-100">
                                        <path fill-rule="evenodd" d="M12.97 3.97a.75.75 0 011.06 0l7.5 7.5a.75.75 0 010 1.06l-7.5 7.5a.75.75 0 11-1.06-1.06l6.22-6.22H3a.75.75 0 010-1.5h16.19l-6.22-6.22a.75.75 0 010-1.06z" clipRule="evenodd"></path>
                                    </svg>
                                </a>
                            </div>
                        </div>
