...
export class ModelQueryResponse extends jspb.Message {
  hasModel(): boolean;
  clearModel(): void;
  ...
  getResponseCase(): ModelQueryResponse.ResponseCase;
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ModelQueryResponse.AsObject;
  static toObject(includeInstance: boolean, msg: ModelQueryResponse): ModelQueryResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: ModelQueryResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ModelQueryResponse;
  static deserializeBinaryFromReader(message: ModelQueryResponse, reader: jspb.BinaryReader): ModelQueryResponse;
}

export namespace ModelQueryResponse {
  export type AsObject = {
