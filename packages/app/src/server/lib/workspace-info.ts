...
export const getWorkspaceInfo = async ({req, res, params}: GetServerSidePropsContext): Promise<WorkspaceInfoResult> => {
...
export const getWorkspaceInfoDiscrete = async (context: GetServerSidePropsContext): Promise<WorkspaceInfoResultDiscrete> => {
