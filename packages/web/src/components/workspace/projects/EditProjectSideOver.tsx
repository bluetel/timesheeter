...
export const EditProjectSideOver = ({
  ...
  const { mutate: createProject } = api.workspace.projects.create.useMutation(mutationArgs);

  const { mutate: updateProject } = api.workspace.projects.update.useMutation(mutationArgs);
...
const useProjectFields = (methods: ReturnType<typeof useZodForm<typeof mutationSchema>>) => {
