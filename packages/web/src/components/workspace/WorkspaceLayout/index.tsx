...
export const WorkspaceLayout = ({ workspaceInfo, secondAside, children }: WorkspaceLayoutProps) => {
      ...
      <div className="flex h-screen bg-white">
        ...
        <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
          ...
          <div className="relative z-0 flex max-h-screen flex-1 overflow-hidden">
            <main className="relative z-0 flex-1 overflow-y-auto focus:outline-none xl:order-last">{children}</main>
            {secondAside && (
