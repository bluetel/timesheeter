...
import { createHolidaySchema, updateHolidaySchema } from '@timesheeter/web/lib/workspace/holidays';
...
export const holidaysRouter = createTRPCRouter({
  ...
  update: protectedProcedure.input(updateHolidaySchema).mutation(async ({ ctx, input }) => {
...
type AuthorizeResult<HolidayId extends string | null> = HolidayId extends null ? null : Holiday;
